...
<div class="row">
	...
	<div class="col-12">
		<div style="padding-bottom: 5px; padding-top: 5px;">
		  ...
		  <button  id="remSelected" style="display: none;" class="btn bg-red" onclick="SistemaRemoveReportSelected()"><i class="fa fa-trash"></i> <span id="selected"></span> <?= $_selected ?></button>
		</div>
	</div>
	</div>
