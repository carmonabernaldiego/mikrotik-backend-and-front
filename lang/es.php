...
$_admin = "Inicio de Sesión";
$_admin_settings = "Configuración";
$_all = "Todo";
...
<li>Para los filtros por mes, seleccione Día y mes, luego haga clic en Filtro.<br>
	...
	<li>Filtre en base a los comentarios, complete el !!Comentario en la columna Buscar y luego haga clic en filtro O haga clic en uno de los comentarios. (Sistema Online).</li>
