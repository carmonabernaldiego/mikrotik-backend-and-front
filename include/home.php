...
<div id="reloadHome">
  ...
  <div class="row">
            ...
            <div class="col-12">
              <div class="box bmh-75 box-bordered">
                <div style="margin-bottom: 10px;">
                  <h3><?php echo $interface;?></h3>
                </div>
                <div class="progress">
                  <div class="progress-bar"
                    style="width: <?php echo $getinterfacetraffic[0]['tx-bits-per-second']/$maxtx*100;?>%"></div>
                </div>
                ...
                <div class="progress">
                  <div class="progress-bar"
                    style="width: <?php echo $getinterfacetraffic[0]['rx-bits-per-second']/$maxrx*100;?>%"></div>
                </div>
                <span class="progress-description">
                  Rx : <?php echo $rx." / ".$mxrx;?>
                </span>
    ...
    <div class="col-4">
      <div class="card">
        <div class="card-header">
          <h3><i class="fa fa-align-justify"></i> Hotspot Log</h3>
        </div>
        <div class="card-body">
          <textarea class="bg-dark" style="overflow: auto; width:100%; height:395px; font-size:11px; border:0;"
            disabled>
<?php
